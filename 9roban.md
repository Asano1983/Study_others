...
初手のソフト評価値（目差）は、盤面で高目+7.0、天元+6.7、目外し+6.7、星+6.4、小目+6.0、三々+5.7程度である（中国ルール）。
初手高目は白番が戦形の選択権を持つため、黒番が覚えるべきことが多い。
そのため、著者は黒番は初手天元が多く、天元の定石を詳しめに記載しており、天元以外は白番目線である。

# 天元の定石

初手のソフト評価値は高目に0.3劣るものの、黒の攻め、白のシノギとなり、アマチュア的には黒が打ちやすい。
黒番が戦形の選択権を持つため主導権を握りやすい。
また、マネ碁対策をしなくてもよいというメリットもある。
...
白が反対側の高目に打つと激しい展開になりやすい。

![目外し定石-図4](img/mokuhazushi_1-003.jpg)

白が近くの高目に打つと高目の定石に合流する。
