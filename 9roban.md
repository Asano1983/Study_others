...
初手のソフト評価値（目差）は、盤面で高目+7.0、天元+6.7、目外し+6.6、星+6.4、小目+6.0、三々+5.7程度である（中国ルール）。
...
初手のソフト評価値は高目に0.3目ほど劣るものの、黒の攻め、白のシノギとなり、アマチュア的には黒が打ちやすい。
...
黒は上下を見合いにしてシノギには困らない。

![忍者定石-図3](img/ninja_1_003.jpg)
